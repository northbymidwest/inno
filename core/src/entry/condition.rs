...
mod tests {
    ...
    fn the_six_strings_land_in_the_order_the_format_writes_them() {
        // after_install comes before before_install on the wire, which reads
        // like a mistake and is not one. Swapping them still parses, still
        // produces two plausible strings, and quietly breaks anything that
        // reads a filename out of before_install.
